...
const CAN = {
  admin:      { create: true, edit: true, delete: true, status: true, print: true, users: true, viewCOD: true, cancelFlash: true },
  shipping:   { create: true, edit: true, delete: false, status: true, print: true, users: false, viewCOD: false, cancelFlash: false },
  accounting: { create: false, edit: false, delete: false, status: false, print: true, users: false, viewCOD: true, cancelFlash: false },
};
